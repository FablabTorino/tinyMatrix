...
unsigned char charset[CHARS][5] PROGMEM = 
{
	...
	{ 0x3D, 0x66, 0x7C, 0x66, 0x3D },	// alien
  	{ 0x00, 0x40, 0x7f, 0x42, 0x00 },	// 1 0x31 49
        { 0x46, 0x49, 0x51, 0x61, 0x42 },	// 2 0x32 50
        { 0x21, 0x4b, 0x45, 0x41, 0x31 },	// 3 0x33 51
        { 0x7f, 0x12, 0x14, 0x18, 0x10 },	// 4 0x34 52
        { 0x39, 0x45, 0x45, 0x45, 0x27 },	// 5 0x35 53
        { 0x30, 0x49, 0x49, 0x4a, 0x3c },	// 6 0x36 54
        { 0x03, 0x05, 0x09, 0x71, 0x01 },	// 7 0x37 55
        { 0x36, 0x49, 0x49, 0x49, 0x36 },	// 8 0x38 56
        { 0x1e, 0x29, 0x49, 0x49, 0x06 },	// 9 0x39 57
//	{ 0x, 0x, 0x, 0x, 0x }
};
...
void render_countdown()
{
	...
	switch (frame%20)
	{
		case 0:  render_character(23);	break;	
		case 1:  clear_bitmap();	break;	
		case 2:  render_character(22);	break;	
		case 3:  clear_bitmap();	break;	
		case 4:  render_character(21);	break;	
		case 5:  clear_bitmap();	break;	
		case 6:  render_character(20);	break;	
		case 7:  clear_bitmap();	break;	
		case 8:  render_character(19);	break;	
		case 9:  clear_bitmap();	break;	
		case 10: render_character(18);	break;	
		case 11: clear_bitmap();	break;	
		case 12: render_character(17);	break;	
		case 13: clear_bitmap();	break;	
		case 14: render_character(16);	break;	
		case 15: clear_bitmap();	break;	
		case 16: render_character(15);	break;	
		case 17: clear_bitmap();	break;	
	}
}
...
void render_buffer()
{
	...
	switch(mode)
	{
		...
		case 19: render_character(15);	break;
		case 20: render_character(16);	break;
		case 21: render_character(17);	break;
		case 22: render_character(18);	break;
		case 23: render_character(19);	break;
		case 24: render_character(20);	break;
		case 25: render_character(21);	break;
		case 26: render_character(22);	break;
		case 27: render_character(23);	break;
                case 28: render_countdown();	break;
	}
}
